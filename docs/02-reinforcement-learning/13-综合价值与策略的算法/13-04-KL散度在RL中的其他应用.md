...
- Pathak, D., Agrawal, P., Efros, A. A., & Darrell, T. (2017). [Curiosity-driven Exploration by Self-supervised Prediction](https://arxiv.org/abs/1705.05363). ICML 2017.
- Ho, J., & Ermon, S. (2016). [Generative Adversarial Imitation Learning](https://proceedings.neurips.cc/paper/2016/hash/cc7e2b878868cbae992d1fb743995d8f-Abstract.html). NeurIPS 2016.
